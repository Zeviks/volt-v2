...
const Home = () => {
  return (
    <section className="bg-white h-full mt-10">
      <div className="grid max-w-screen-xl px-4 py-8 mx-auto my-6 lg:gap-8 xl:gap-10 lg:py-16 lg:grid-cols-12">
        <div className="mr-auto place-self-center lg:col-span-6">
          <h1 className="max-w-2xl mb-4 font-extrabold leading-none md:text-5xl xl:text-4xl text-slate-900">
            High-quality Video Conferencing With No Strings Attach.
          </h1>
          <p className="max-w-2xl mb-6 font-light text-slate-900 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">
          ...
          <div className="flex items-center">
            <a
              href="/#"
              className="inline-flex items-center justify-center px-8 py-4 mr-3 text-base font-medium text-center text-white rounded-[5px] bg-slate-900 hover:bg-indigo-500 focus:ring-4 focus:ring-blue-300 dark:focus:ring-blue-900 transition-all"
            >
