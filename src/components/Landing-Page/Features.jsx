...
const Features = () => {
  return (
    <section className="bg-slate-100 dark:bg-slate-800 mb-10">
      <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
        <div className="max-w-screen-md mb-8 lg:mb-16">
          <h2 className="mb-4 text-4xl font-bold text-slate-900 dark:text-white">
            Designed with ease in mind from the start
          </h2>
          <p className="text-slate-500 sm:text-xl dark:text-slate-400">
        ...
        <div className="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-2 md:gap-12 md:space-y-0">
          <div>
            <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-indigo-100 lg:h-12 lg:w-12 dark:bg-indigo-900">
              <svg
                className="w-5 h-5 text-indigo-500 lg:w-6 lg:h-6 dark:text-indigo-300"
                fill="currentColor"
                viewBox="0 0 20 20"
