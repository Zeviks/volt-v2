...
const Navbar = () => {
  ...
  <a href="https://flowbite.com/" class="flex items-center h-6 md:mr-[6.4rem] sm:mr-0 sm:h-9">
      <BsLightningFill class="w-8 h-8 mr-auto hover:text-indigo-500 transition-all" />
  </a>
  <div class="flex md:order-2">
      <button type="button" class="text-black hover:text-white border-[1px] border-black hover:bg-indigo-500 font-medium rounded-[5px] text-sm px-8 py-2.5 text-center mr-3 md:mr-0 transition-all">Contact</button>
  ...
  <div class="hidden justify-between items-center w-full md:flex md:w-auto md:order-1" id="navbar-cta">
    <ul class="flex flex-col p-4 mt-4 bg-gray-50 rounded-lg border border-gray-100 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
      <li>
        <a href="#" class="block py-2 pr-4 pl-3 text-white rounded md:bg-transparent md:text-indigo-500 md:p-0 transition-all" aria-current="page">Home</a>
      </li>
      <li>
