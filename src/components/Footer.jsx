...
const Footer = () => {
  return (
    <div className="relative mt-16 bg-indigo-500">
      <svg
        className="absolute top-0 w-full h-6 -mt-5 sm:-mt-10 sm:h-16 text-indigo-500"
      ...
      <div className="px-4 pt-12 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
        <div className="grid gap-16 row-gap-10 mb-8 lg:grid-cols-6">
          <div className="md:max-w-md lg:col-span-2">
            ...
            >
              <BsLightningFill className="w-8 text-white" />
            ...
            <div>
              ...
              <ul className="mt-2 space-y-2">
                <li>
                  <a
                    href="/"
                    className="transition-colors duration-300 text-indigo-300 hover:text-white"
                  >
                    News
                  </a>
                </li>
        ...
        <div className="flex flex-col justify-between pt-5 pb-10 border-t border-deep-purple-accent-200 sm:flex-row">
          <p className="text-sm text-gray-100">
            © Copyright 2022 Natanael Pacheco. All rights reserved.
          </p>
